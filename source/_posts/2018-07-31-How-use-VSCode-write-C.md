...
date: 2018-9-2 21:41:18
updated: 2019-3-24 10:25:22
thumbnail: /How-use-VSCode-write-C/thumbnail.png
categories: [记事簿]
tags: [Code,VSCode,Editer]
---
...
## 环境变量配置
  ...
  ![gcc-v](2018-07-31-How-use-VSCode-write-C/gcc-v.png)

# VSCode 中的配置

## 安装插件

  ![VSCodePluginCC++](2018-07-31-How-use-VSCode-write-C/VSCodePluginCC++.png)
...
下面**以一个 C 语言文件夹为例**（如果你想配置 C++ ，记得替换相应的参数）：
  ...
  ![VSCode下的四个json效果图](2018-07-31-How-use-VSCode-write-C/VSCodeFourJsonFile.png)
...
## 补全 "includepath"
  ...
  ![头文件处有小灯泡提示添加includepath](2018-07-31-How-use-VSCode-write-C/WarnAddIncludepath.png)
...
![RunCode所在的位置](2018-07-31-How-use-VSCode-write-C/RunCode.png)
